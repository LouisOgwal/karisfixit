// Hero.jsx - Removed system status badge
        ...
        <div className="lg:col-span-7">
          ...
          <div className="bg-muted/40 p-6 border border-border flex-1 min-w-[280px]">
            ...
            <div className="flex gap-2">
              <select className="flex-1 bg-background border border-border px-3 py-2 text-sm focus:border-primary outline-none">
